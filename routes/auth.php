...
Route::middleware('guest')->group(function () {
    ...
    // ── MFA challenge (post-login TOTP prompt, user not yet fully authed) ──
...
Route::middleware('auth')->group(function () {
    ...
    Route::put('two-factor-authentication/confirm', [TwoFactorAuthenticationController::class, 'confirm'])
