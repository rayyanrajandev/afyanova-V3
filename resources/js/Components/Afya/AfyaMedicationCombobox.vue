...
<template>
    ...
    >
        ...
        <div
            v-if="isOpen"
            class="absolute left-0 z-100 bg-popover text-popover-foreground border border-border/80 rounded-lg shadow-2xl overflow-hidden animate-in fade-in-0 duration-100 flex flex-col w-full min-w-[300px] sm:min-w-[500px] max-w-[calc(100vw-2rem)]"
