...
class SyncMasterDictionaryAction
{
    ...
    public function execute(string $dictionaryType, ?string $targetTenantId = null): array
    {
        ...
        $this->auditLogger->log(
            ...
            auditableId: $targetTenantId ?? (string) Str::uuid(),
            before: null,
            after: [
            ...
            facilityId: null,
            tenantId: $targetTenantId ?? $tenants->first()?->id,
            justification: 'Superadmin automated master dictionary broadcast to hospital databases.'
        );
