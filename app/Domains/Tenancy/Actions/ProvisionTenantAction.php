    ...
    public function execute(array $data): Tenant
    {
        return DB::transaction(function () use ($data) {
            ...
            $tenant = Tenant::create([
                ...
                'storage_quota_mb' => $data['storage_quota_mb'] ?? 10240,
            ...
            $facility = Facility::create([
                'tenant_id' => $tenant->id,
                'name' => $data['main_facility_name'] ?? ($tenant->name . ' - Main Branch'),
            ...
            $this->auditLogger->log(
                ...
                tenantId: $tenant->id,
                justification: 'Superadmin automated hospital organization onboarding wizard.'
            );
